...
export const MODULE5_QUESTIONS_ES: Record<string, QuestionTextOverride> = {
  ...
  P3: { prompt: "En los últimos momentos antes de entregar o presentar algo, ¿cómo lo vives?", optionLabels: ["Termino con tiempo de sobra", "Lo repaso un poco a última hora", "Sigo corrigiendo y la fecha de entrega me pisa los talones", "Como nunca me convence, no logro soltarlo hasta el final"] },
  P4: { prompt: "Si no puedo hacerlo perfecto, prefiero no empezar.", optionLabels: ["No me describe", "Me describe mucho"] },
  ...
  T4: { prompt: "Lo que no me apetece hacer solo lo empiezo cuando la fecha límite ya está encima.", optionLabels: ["No me describe", "Me describe mucho"] },
  ...
  D1: { prompt: "Cuando tienes varias opciones delante, ¿qué haces?", optionLabels: ["Elijo una rápidamente", "Lo pienso un poco y elijo", "Comparo durante un buen rato antes de elegir", "No logro decidirme y dejo que otra persona elija"] },
  ...
  D4: { prompt: "Incluso ante una decisión sin importancia, solo logro tranquilizarme cuando repaso mentalmente todos los resultados posibles.", optionLabels: ["No me describe", "Me describe mucho"] },
  ...
  D7: { prompt: "Cuando te informas antes de decidir, ¿cómo te sueles comportar?", optionLabels: ["Ordeno lo que tengo y decido cuando me parece razonable", "Busco un poco más antes de decidir", "Acabo buscando sin parar", "Hay tanta información que no logro decidirme"] },

...
export const MODULES: ModuleDefinition[] = [
  ...
  },
  {
    ...
    subtitle: { ko: "결핍공포 / 과시욕 / 회피", en: "Scarcity Fear / Ostentation / Avoidance", es: "Miedo a la escasez / Afán de aparentar / Evitación" },
  ...
  },
  {
    ...
    subtitle: { ko: "소진 / 냉소 / 효능감저하", en: "Exhaustion / Cynicism / Reduced Efficacy", es: "Falta de energía / Cinismo / Poca eficacia" },
  ...
  },
  {
    ...
    subtitle: { ko: "이미지관리 / 은폐 / 관계피로", en: "Image Management / Concealment / Social Fatigue", es: "Cuidado de la imagen / Ocultamiento / Cansancio social" },
  ...
  },
  {
    ...
    subtitle: { ko: "완벽주의 / 회피 / 선택마비", en: "Perfectionism / Avoidance / Decision Paralysis", es: "Perfeccionismo / Evitación / Dificultad para decidir" },
  ...
  },
  {
    ...
    subtitle: { ko: "인지적각성 / 신체적각성 / 무의식누수", en: "Racing Mind / Tense Body / Restless Dreams", es: "Mente activa / Cuerpo en tensión / Sueños inquietos" },
  ...
  },
  {
    ...
    subtitle: { ko: "정서적얽힘 / 정서적단절 / 역할부담", en: "Emotional Entanglement / Emotional Distance / Grown-Up Roles Early", es: "Fusión emocional / Corte emocional / Carga de roles" },
  ...
  },
  {
    ...
    subtitle: { ko: "표현억제 / 즉흥성억제 / 확신부족", en: "Expression Suppression / Suppressed Spontaneity / Lack of Confidence", es: "Expresión contenida / Espontaneidad frenada / Poca seguridad" },

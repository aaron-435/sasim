...
export const MODULE3_QUESTIONS_ES: Record<string, QuestionTextOverride> = {
  E1: { prompt: "¿Cuánto cansancio sientes después del trabajo (o al terminar tu día)?", minLabel: "Nada de cansancio", maxLabel: "Sin fuerzas" },
  E2: { prompt: "En una semana normal, ¿cuántos días te queda energía?", optionLabels: ["Casi todos los días estoy bien", "Con el fin de semana me recupero", "Estoy sin energía toda la semana", "Ni recuerdo la última vez que estuve bien"] },
  E3: { prompt: "Cuando abres los ojos por la mañana, ¿qué sientes?", optionLabels: ["Tengo ganas de empezar el día", "Consigo levantarme, aunque cuesta", "Solo levantarme ya pesa", "Nada más despertar, ya estoy sin energía"] },
  E4: { prompt: "Ante tareas sencillas (contestar correos, pendientes pequeños), ¿qué haces?", optionLabels: ["Las resuelvo enseguida", "Las dejo para después, pero las termino", "Las sigo aplazando porque ni ganas tengo de tocarlas", "Solo de pensarlas me quedo sin energía"] },
  E5: { prompt: "Cuando termina el fin de semana o unas vacaciones, ¿cómo estás?", optionLabels: ["Vuelvo con la energía renovada", "Me recupero hasta cierto punto", "Descansar no cambia mucho", "Hasta descansar me cansa"] },
  E6: { prompt: "¿Cómo está tu cuerpo (dolores de cabeza, malestar digestivo, tensión muscular, etc.)?", optionLabels: ["Nada fuera de lo normal", "A veces algo de rigidez o cansancio", "Algo me duele o me molesta de forma constante", "Casi no hay parte de mi cuerpo que no me moleste"] },
  E7: { prompt: "¿Cómo te sientes al terminar el día?", optionLabels: ["Con sensación de logro", "Solo con la sensación de que el día pasó", "Con sensación de agotamiento", "Con la sensación de que no puedo seguir mucho más"] },
  E8: { prompt: "¿Cómo estás justo antes de dormir?", optionLabels: ["Me duermo sin problema", "Doy algunas vueltas antes de dormirme", "Tengo cansancio, pero me cuesta dormirme", "Mi cuerpo está agotado, pero mi mente sigue muy activa"] },
  E9: { prompt: "Cuando llega una tarea o petición nueva, ¿qué pasa?", optionLabels: ["Tengo energía para asumirla con gusto", "Es una carga, pero la saco adelante", "Me parece demasiado para mí", "Ya estoy en mi límite y quiero decir que no"] },
  E10: { prompt: "¿Cómo describirías tu nivel general de energía ahora mismo?", optionLabels: ["De sobra", "Normal", "Casi sin reservas", "Sin nada de energía"] },
  C1: { prompt: "¿Cuánta indiferencia o cinismo sientes hacia tu trabajo?", minLabel: "Ninguna (todavía me importa)", maxLabel: "Total indiferencia y cinismo" },
  C2: { prompt: "Al tratar con compañeros o clientes, ¿cómo te comportas?", optionLabels: ["Los trato con el mismo cuidado de antes", "Soy un poco más formal que antes", "Mantengo la distancia y me limito a lo laboral", "Me vienen pensamientos cínicos con frecuencia"] },
  C3: { prompt: "¿Cuánto te importa el resultado de tu trabajo?", optionLabels: ["Todavía me importa de verdad", "Me importa lo razonable", "Solo me importa terminarlo", "Siento que da igual que salga bien o no"] },
  C4: { prompt: "¿Qué sientes hacia tu empresa (u organización)?", optionLabels: ["Le tengo cariño", "Me da igual, nada especial", "Siento cierta distancia", "Siento un cinismo o una desilusión fuertes"] },
  C5: { prompt: "Eso que antes te apasionaba, ¿cómo se siente ahora?", optionLabels: ["Esa pasión sigue ahí", "Es menos que antes, pero sigue", "Casi no logro recordar esa sensación", "Se siente tan lejano que me pregunto por qué me importaba tanto"] },
  C6: { prompt: "¿Con qué frecuencia te vienen pensamientos cínicos (como «total, nada de esto importa») en el trabajo?", optionLabels: ["Casi nunca", "De vez en cuando", "A menudo", "Casi todos los días"] },
  C7: { prompt: "¿Cuánto confías en las personas con las que trabajas?", optionLabels: ["Todavía mucho", "En general, bien", "Desconfío más que antes", "He dejado de confiar en casi todos"] },
  C8: { prompt: "Cuando piensas en el sentido o el propósito de tu trabajo, ¿qué sientes?", optionLabels: ["Le veo un sentido claro", "Tiene algo de sentido, más o menos", "Me cuesta encontrarle sentido", "Todo me parece sin sentido"] },
  C9: { prompt: "¿Cómo reaccionas cuando surge un problema?", optionLabels: ["Intento resolverlo activamente", "Suelo esforzarme por resolverlo", "Lo dejo pasar", "Me resigno pensando que nada va a cambiar"] },
  C10: { prompt: "Cuando hablas de tu trabajo, ¿cómo suena tu tono?", optionLabels: ["Positivo", "Bastante neutro", "Termina siendo cínico", "Termina siendo sarcástico o de burla hacia mí"] },
  F1: { prompt: "¿Cuánto dudas de tu propia capacidad o de tus logros?", minLabel: "Nada de duda (tengo confianza)", maxLabel: "Una duda enorme" },
  F2: { prompt: "¿Cuánta confianza tienes en tus propias capacidades?", optionLabels: ["Sé bien en qué destaco", "En general me siento bien", "A menudo dudo de si lo estoy haciendo bien", "Siento que no hago nada bien"] },
  F3: { prompt: "Cuando recibes un cumplido, ¿qué haces?", optionLabels: ["Lo acepto con gratitud", "Me alegra, pero me da algo de vergüenza", "Siento que no lo merezco", "No logro creérmelo del todo"] },
  F4: { prompt: "Cuando te dan una tarea difícil, ¿qué sientes?", optionLabels: ["Confío en que puedo lograrlo", "Es una carga, pero lo intento", "Me pregunto si de verdad podré con ella", "Me siento impotente antes de empezar"] },
  F5: { prompt: "Cuando cometes un error, ¿qué haces?", optionLabels: ["Lo dejo pasar, son cosas que pasan", "Reflexiono y presto más atención la próxima vez", "Pienso: «claro, es que no sirvo para esto»", "Me duele, como si quedara al descubierto mi incompetencia"] },
  F6: { prompt: "¿Cómo valoras tu capacidad en comparación con la de los demás?", optionLabels: ["Me siento más que capaz", "Me siento a un nivel parecido al de todos", "A menudo siento que me quedo atrás", "Siempre siento que no soy suficiente"] },
  F7: { prompt: "Cuando tienes que tomar una decisión importante, ¿qué haces?", optionLabels: ["Confío en mi criterio", "Le doy muchas vueltas, pero termino confiando en mí", "Sigo dudando de si mi criterio es acertado", "Siento que no tengo capacidad para decidir"] },
  F8: { prompt: "Cuando miras atrás y ves lo que has logrado, ¿qué sientes?", optionLabels: ["Siento orgullo", "Siento que no está mal", "Siento que fue sobre todo suerte o mérito de otros", "Siento que no he logrado nada de verdad"] },
  F9: { prompt: "Cuando te asignan un rol o una responsabilidad nueva, ¿cómo lo tomas?", optionLabels: ["Me ilusiona y siento que puedo hacerlo bien", "Es una carga, pero parece asumible", "Me da miedo no poder con ello", "Siento que tarde o temprano quedará al descubierto mi incompetencia"] },
  F10: { prompt: "¿Cómo te valoras en general?", optionLabels: ["Creo que soy bastante capaz", "Creo que estoy en un nivel medio", "A menudo siento que no llego", "Muchas veces me siento incompetente"] },
};
...
export const MODULE3_DIMENSION_LABELS: Record<Locale, Record<string, { high: string; low: string }>> = {
  ...
  es: {
    exhaustion: { high: "Falta de energía", low: "Energía recuperada" },
    cynicism: { high: "Cinismo", low: "Aprecio por el trabajo" },
    efficacyLoss: { high: "Poca eficacia", low: "Confianza en tu capacidad" },
  },
};
...
export const MODULE3_TYPE_NAMES: Record<Locale, Record<string, { title: string; hook: string }>> = {
  ...
  es: {
    "baseline": { title: "Ritmo propio", hook: "Por ahora, ni la falta de energía, ni el cinismo, ni la duda sobre tu eficacia destacan con claridad: un estado relativamente estable." },
    "exhaustion": { title: "Sin energía", hook: "Tu energía está por los suelos, pero tu aprecio por el trabajo y tu confianza en ti siguen ahí." },
    "cynicism": { title: "Cinismo", hook: "Tu cuerpo todavía aguanta, pero tu ilusión por el trabajo y la organización se está enfriando." },
    "efficacyLoss": { title: "Confianza a la baja", hook: "Sin importar tu desempeño real, tu confianza en tu propia capacidad se está tambaleando." },
    "exhaustion+cynicism": { title: "Agotamiento avanzado", hook: "La energía se acabó y las ganas de trabajar también se van apagando: el agotamiento laboral está bastante avanzado." },
    "exhaustion+efficacyLoss": { title: "Sin fuerzas y con dudas", hook: "Estás sin fuerzas y dudando de ti al mismo tiempo, una combinación frecuente cuando hay agotamiento laboral." },
    "cynicism+efficacyLoss": { title: "Desilusión y desánimo", hook: "Tanto el sentido que le encuentras al trabajo como tu confianza en ti se han ido apagando a la vez." },
    "exhaustion+cynicism+efficacyLoss": { title: "Agotamiento completo", hook: "El cuadro clásico de agotamiento laboral: la falta de energía, el cinismo y la baja confianza en tu eficacia están presentes con claridad." },
  },
};

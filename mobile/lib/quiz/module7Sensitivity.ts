...
export const MODULE7_QUESTIONS_ES: Record<string, QuestionTextOverride> = {
  ...
  X6: { prompt: "Cuando alguien te mira mientras trabajas, ¿qué te pasa?", optionLabels: ["Nada distinto de lo normal", "Me molesta un poco", "Me tenso y cometo más errores", "No consigo rendir a mi nivel habitual"] },
  ...
  X10: { prompt: "Cuando varias personas te hablan a la vez, ¿qué te pasa?", optionLabels: ["Lo llevo sin problema", "Se me hace un poco pesado", "No sé a quién atender primero", "Me quedo en blanco y no consigo responder"] },
  ...
  A7: { prompt: "¿Cómo de bien notas las diferencias sutiles de color o textura?", optionLabels: ["No suelo distinguirlas", "Las noto de vez en cuando", "Las noto bastante bien", "Noto diferencias que otros ni perciben"] },
  ...
  L7: { prompt: "¿Cómo de bien te concentras en un ambiente con varios sonidos a la vez?", optionLabels: ["Muy bien", "Razonablemente bien", "Me distraigo con facilidad", "Es casi imposible"] },

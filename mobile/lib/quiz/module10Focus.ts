...
export const MODULE10_QUESTIONS_ES: Record<string, QuestionTextOverride> = {
  ...
  D2: { prompt: "Aunque esté en plena tarea, otro estímulo visible (una notificación, un sonido, etc.) me distrae al instante.", optionLabels: ["Nada cierto", "Muy cierto"] },
  D3: { prompt: "Durante una conversación, ¿qué te pasa?", optionLabels: ["Escucho con toda mi atención de principio a fin", "Sigo la conversación casi todo el tiempo", "Se me va la cabeza a mitad de conversación", "A menudo tengo que preguntar de nuevo lo que me he perdido"] },
  D4: { prompt: "¿Cómo se mantiene tu escritorio o tu espacio de trabajo?", optionLabels: ["Ordenado", "Lo ordeno con cierta regularidad", "Se desordena enseguida", "Dejo varias cosas fuera de sitio y no logro ordenarlo"] },
  D5: { prompt: "Antes de terminar una tarea, si aparece algo más interesante, cambio a eso al instante.", optionLabels: ["Nada cierto", "Muy cierto"] },
  D6: { prompt: "Cuando haces algo aburrido, ¿qué te pasa?", optionLabels: ["Aguanto y lo termino", "Lo saco adelante a base de paciencia", "Se me va la cabeza una y otra vez", "Simplemente no consigo concentrarme"] },
  D7: { prompt: "¿Cómo de bien recuerdas dónde has dejado las cosas (las llaves, tus documentos, etc.)?", optionLabels: ["Casi nunca se me olvida", "A veces me hago un lío", "A menudo no las encuentro", "Las busco cada vez"] },
  D8: { prompt: "Cuando tengo varias ventanas abiertas y voy saltando de una a otra, a veces olvido lo que quería hacer al principio.", optionLabels: ["Nada cierto", "Muy cierto"] },
  ...
  H2: { prompt: "Cuando me sumerjo en algo que me encanta, a veces me olvido de comer.", optionLabels: ["Nada cierto", "Muy cierto"] },
  ...
  H5: { prompt: "Cuando algo me atrapa, dejo otras cosas importantes completamente en segundo plano.", optionLabels: ["Nada cierto", "Muy cierto"] },
  ...
  I2: { prompt: "En lugar de pensar antes de hablar, muchas veces las palabras me salen primero.", optionLabels: ["Nada cierto", "Muy cierto"] },
  ...
  I5: { prompt: "Tener que esperar mi turno o esperar a que algo suceda me resulta especialmente difícil de soportar.", optionLabels: ["Nada cierto", "Muy cierto"] },
  I6: { prompt: "¿Cómo de bien mantienes una rutina regular (ejercicio, hábitos, etc.)?", optionLabels: ["La mantengo con constancia", "La mantengo casi siempre", "Se me apaga enseguida", "La abandono a los pocos días"] },
  ...
  I9: { prompt: "Empezar algo nuevo me atrae más que seguir con una sola cosa hasta terminarla.", optionLabels: ["Nada cierto", "Muy cierto"] },

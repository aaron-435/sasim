...
export const MODULE6_QUESTIONS_ES: Record<string, QuestionTextOverride> = {
  ...
  S3: { prompt: "Aunque me enfade, la otra persona no se da cuenta en absoluto.", optionLabels: ["No me describe", "Me describe mucho"] },
  ...
  E3: { prompt: "Cuando me enfado, a veces estallo tan de repente que ni yo mismo puedo controlarlo.", optionLabels: ["No me describe", "Me describe mucho"] },
  ...
  R4: { prompt: "Aunque ya haya pasado, antes de dormir repaso la situación una y otra vez y me vuelvo a enfadar.", optionLabels: ["No me describe", "Me describe mucho"] },

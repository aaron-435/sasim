      ...
      overviewVariants: [
        {
          ...
          body: "La energía de hoy coincide con tu manera de ser. No hace falta disfrazarte ni aparentar otra cosa: moverte como lo haces siempre es justo lo que mejor te funciona hoy. Resolver las cosas a tu manera suele salir más fluido de lo que esperas, y conviene apoyarte en una rutina probada antes que buscar algo desconocido. Eso sí, al ser una energía idéntica a la tuya, los puntos ciegos que no sueles ver se quedan igual de ocultos. Si hay algo que acostumbras pasar por alto, hoy puede volver a asomar, así que revísalo una vez más. En las conversaciones conectarás con facilidad con quienes se te parecen, pero con quien ve las cosas de otra forma puede que cada uno acabe hablando por su lado. En vez de buscar algo nuevo, hoy te rinde más consolidar y ordenar lo que ya tienes. Es un día cómodo y sin sobresaltos; solo no confundas esa comodidad con quedarte quieto.",
        },
        {
          headline: "Un día con ropa de siempre",
          body: "Igual que cuando te pones una prenda que ya te queda bien, hoy lo acertado es actuar con naturalidad. En lugar de forzar algo nuevo, llena el día con los métodos y herramientas que ya dominas: es probable que los resultados salgan más sólidos de lo habitual. Pero así como la ropa cómoda hace que sigas posponiendo ordenar el armario, hoy hay una tentación real de seguir aplazando las tareas pendientes. Elige una cosa pequeña y termínala hoy; quien seas mañana te lo agradecerá. En las conversaciones, tu forma habitual de hablar suena más sincera que cualquier cosa preparada para la ocasión. No necesitas un gran gesto: es probable que la gente te encuentre agradable tal como eres. Deja los planes ambiciosos a un lado y deja que el día fluya a su ritmo; al final, eso es lo que más rinde.",
        },
        {
          headline: "Sobre la misma ola",
          body: "La energía de hoy va en la misma dirección y al mismo ritmo que la ola sobre la que ya venías. No necesitas forzar un nuevo rumbo ni cambiar tu paso: dejarte llevar por la corriente actual basta para avanzar. Mantener tus patrones de siempre, en el trabajo o en las relaciones, juega a tu favor; cambiar de golpe puede hacerte perder el equilibrio. Pero la misma ola también implica el mismo sitio donde tropezar. Si hay un error o un hábito que ya te ha hecho caer antes, prepárate por si hoy vuelve a sacudirte. Si hablas con alguien de temperamento parecido al tuyo, todo se sentirá inusualmente fácil, y podrán entenderse sin necesidad de una charla larga. Con alguien que tiene otra sintonía, la diferencia puede notarse más de lo normal. En vez de buscar una ola nueva, aprovecha hoy para practicar cómo montar mejor la que ya tienes.",
        },
        {
          headline: "En el camino de siempre",
          body: "Hoy, recorrer el camino que ya conoces es la opción más segura y eficiente. En lugar de redibujar el mapa o buscar un atajo, moverte por una ruta conocida te ahorra tiempo y energía. Pero así como en un camino conocido dejas de mirar dónde pisas, hoy existe el riesgo de repetir sin darte cuenta un error de siempre. Todo lo que ya te ha hecho tambalear antes, como el dinero o los compromisos, merece una revisión más. En las conversaciones, la comodidad se multiplica con las personas que conoces desde hace tiempo, y los vínculos se afianzan de forma natural sin necesidad de sacar temas difíciles. Conocer a alguien nuevo o entrar en un entorno desconocido puede emocionar menos de lo habitual, pero eso no es mala señal. Los logros de hoy vendrán más de la constancia que de algo llamativo. Tómalo como un día para confirmar que vas por buen camino.",
        },
      ],
      wealth: "El dinero se mueve hoy a su ritmo habitual, sin nada dramático en un sentido ni en otro. Es mejor seguir con lo que ya haces que lanzarte a una inversión nueva o a una compra grande.",
      love: "El amor se mantiene tranquilo y estable, sin sobresaltos. Los vínculos de siempre se sienten cómodos, aunque hoy es menos probable que te atraiga con fuerza alguien nuevo.",
      health: "Tu cuerpo se mantiene en su nivel de siempre, sin grandes subidas ni bajadas. Lo importante hoy es conservar tus hábitos actuales en lugar de cambiar algo.",
    },
    selfNurturesOther: {
      overviewVariants: [
        {
          headline: "Una lámpara encendida",
          body: "Hoy tu energía fluye en una dirección que ilumina primero todo lo que te rodea. Hablar antes que nadie en una reunión, o empezar algo que te daba dudas, suele funcionar especialmente bien. Cuando los demás vacilan, que tú te muevas primero suele destrabar las cosas con más facilidad de la que esperas. Pero igual que una lámpara gasta su aceite cuanto más tiempo está encendida, si sigues alumbrando a todos los demás puede que al anochecer no te quede nada para ti. Baja la llama y tómate un descanso a mitad del día. Hoy también favorece ser quien da el primer paso con el dinero o con una propuesta: si tienes algo guardado desde hace tiempo, es un buen día para plantearlo. Solo cuida que dar sin parar no te deje sin fondos ni sin ánimo. La luz que enciendas hoy probablemente llegue más lejos y dure más de lo que imaginas.",
        },
        {
          headline: "Un manantial para los demás",
          body: "Como un manantial que nunca se seca, hoy la energía que sale de ti reconforta en silencio a quienes te rodean. Dar un consejo o echar una mano te sale con naturalidad, y es probable que lo vivas como algo ligero, no como una carga. Acercarte y ocuparte de los demás primero también funciona bien en las relaciones: si hay un mensaje que llevas tiempo posponiendo, hoy es buen día para enviarlo. Pero incluso un manantial baja de nivel si sigues sacando agua, así que no olvides que tus emociones y tus fuerzas también tienen un límite. Cuando alguien se apoye en ti, puedes dar solo lo que tengas hoy en vez de todo lo que te pidan. En el trabajo, tomar la iniciativa con una propuesta o una dirección probablemente dé buenos frutos. Antes de que acabe el día, dedica un rato a recargarte tú también.",
        },
        {
          headline: "Viento a favor para otra persona",
          body: "La energía de hoy sopla en la misma dirección que el viento que llena las velas de otra persona. Si das un paso al frente para sugerir un rumbo o dar un empujón, es probable que veas a esa persona avanzar con mucha más facilidad de la que esperaba. Liderar, o ser quien propone algo primero, te va especialmente bien hoy, y dar la cara se siente más satisfactorio que mirar desde atrás. Pero así como un viento demasiado fuerte puede desbordar una vela, el ritmo al que empujas quizá no coincida con el que la otra persona puede seguir; ten presente esa diferencia. De vez en cuando afloja un poco y fíjate en cómo reacciona. En lo económico, mover ficha primero con un gasto o una inversión puede salir bien, pero empujar demasiado fuerte corre el riesgo de topar con resistencia inesperada. Recuerda que el viento que creaste hoy pudo ser justo el impulso que alguien necesitaba.",
        },
        {
          headline: "Un día para tender puentes",
          body: "Hoy te encuentras dando un paso al frente como el puente que une a dos personas, o dos situaciones. Es probable que acabes mediando en un conflicto, pasando información o siendo quien establece el primer contacto, y hoy ese papel se siente natural, así que vale la pena implicarte más de lo habitual. Pero igual que un puente debe soportar el peso de ambos lados, mediar en el medio puede gastar más energía de la que esperas. En lugar de intentar resolverlo todo, basta con crear la conexión y dejar el resto en manos de las personas implicadas. Ser quien se acerca primero en una conversación o en un trabajo en equipo suele suavizar las cosas mucho más que quedarte en silencio. Un puente que tiendas hoy puede volver a ayudarte en un lugar donde no lo esperabas.",
        },
      ],
      wealth: "El dinero tiende a seguirte cuando hoy tomas la iniciativa. Proponer algo o gastar primero suele salir bien; solo cuida que dar sin parar no te deje el bolsillo vacío.",
      love: "Acercarte primero y cuidar del vínculo funciona bien hoy. Es un buen día para llevar la iniciativa, pero asegúrate de dejar también que te cuiden, o puede agotarte.",
      health: "Hoy gastas mucha energía hacia fuera, lo cual va bien para mantenerte activo. Solo recuerda descansar a mitad del día, o llegarás a la noche sin fuerzas.",
    },
    otherNurturesSelf: {
      overviewVariants: [
        {
          headline: "Viento a favor",
          body: "Hoy es como si un viento a favor llenara tus velas sin que tengas que remar. Las cosas salen con más suavidad de la esperada, y alguien puede tenderte una mano antes de que la pidas. Algo que normalmente llevaría días podría resolverse hoy con una rapidez inesperada. Pero si sueltas del todo el timón solo porque el viento sopla a favor, el barco puede acabar donde no querías: déjate llevar por la corriente, pero mantén una mano suave sobre tu propio rumbo. Si llega una propuesta inesperada o una buena noticia, acéptala sin darle demasiadas vueltas. Solo por hoy, puedes dejar a un lado el hábito de resolverlo todo por tu cuenta. Los vientos a favor no duran para siempre, así que aprovecha este tanto como puedas.",
        },
        {
          headline: "Como lluvia de primavera",
          body: "Igual que la lluvia de primavera que empapa en silencio la tierra seca, la energía de hoy te llena sin que tengas que esforzarte. Si vienes sin energía, hoy puede traerte un momento inesperado de consuelo o de recuperación. En las relaciones, es probable que alguien se acerque y se ocupe de las cosas antes que tú, así que lo bueno tiende a suceder de forma natural sin que tengas que empujar. Pero así como demasiada lluvia convierte la tierra en barro, acostumbrarte demasiado a recibir puede apagar tu propio impulso. Acepta con gratitud la ayuda de hoy, pero prepárate para volver a caminar con tus propios pasos mañana. En lo económico, también puede colarse un ingreso inesperado o una buena oferta. En lugar de forzar nada hoy, deja que lo que llegue de forma natural te empape.",
        },
        {
          headline: "Una mano que te sostiene",
          body: "Justo cuando estás a punto de tropezar, hoy la mano de alguien te sostiene con naturalidad. Si hay algo que llevas tiempo intentando resolver por tu cuenta, una ayuda inesperada puede aliviarlo mucho hoy. En momentos así, dejar el orgullo a un lado y aceptar la ayuda es lo más sensato. Solo procura no apoyarte tanto en la mano de otra persona que olvides cómo mantenerte en pie por tu cuenta: usa la ayuda de hoy como peldaño y prepárate para ser tú quien tienda la mano la próxima vez. En las conversaciones, la gente parece entenderte sin que tengas que explicar demasiado, y todo resulta más fácil. También en lo físico, la recuperación llega hoy con una rapidez poco habitual, siempre que no te exijas de más. Guarda en la memoria la ayuda de hoy y devuélvela a alguien más cuando llegue tu turno.",
        },
        {
          headline: "Un rayo de sol",
          body: "Como el sol que entra de pronto en un rincón en sombra, hoy la buena energía llega hacia ti sin esfuerzo. Algo que parecía atascado puede mostrar de repente una salida, o un problema que te preocupaba puede resolverse con más facilidad de la esperada. Además, la gente puede mostrarte una amabilidad o una atención inesperadas, así que vale la pena abrirte un poco más de lo habitual. Pero si pasas todo el día al sol sin hacer nada, cuando pase puede que no te quede nada que mostrar. Aprovecha para dar al menos un pequeño paso mientras dure la buena racha. En lo económico o en el trabajo, también puede llegar una buena noticia inesperada. Disfruta del sol de hoy con calma, pero no olvides sembrar también una semilla para mañana.",
        },
      ],
      wealth: "Hoy el dinero o las buenas oportunidades tienden a llegar sin mucho esfuerzo de tu parte. Si aparece un ingreso inesperado o una ayuda, puedes aceptarlo con tranquilidad.",
      love: "Es probable que hoy sea la otra persona quien se acerque o dé el primer paso. Todo fluye sin mucho esfuerzo por tu parte; déjate cuidar hoy.",
      health: "El apoyo de quienes te rodean, o simplemente un buen momento, puede hacer que hoy sientas el cuerpo mucho más liviano. Mientras no te exijas de más, la recuperación llega rápido.",
    },
    selfChallengesOther: {
      overviewVariants: [
        {
          headline: "Tomar las riendas",
          body: "Hoy tu capacidad para tomar las riendas y llevar las cosas hacia donde quieres es especialmente fuerte. Es un buen momento para tomar una decisión que has ido posponiendo o para sacar adelante una propuesta que tenías guardada. Pero así como tirar demasiado fuerte de las riendas puede desbocar a un caballo, presionar demasiado a alguien puede provocar una resistencia que no esperabas. Guía hacia donde quieres, pero comprueba de vez en cuando si la otra persona puede seguirte el ritmo. Tus argumentos pesan más de lo normal en las conversaciones, así que convencer resulta fácil; solo evita empujar en una sola dirección, porque puede dejar un resentimiento duradero. Una decisión decidida sobre dinero o trabajo probablemente dé buen resultado, pero no lleves las cosas al extremo. Si manejas bien las riendas de hoy, podrás dar un paso importante hacia donde quieres llegar.",
        },
        {
          headline: "Remar con fuerza",
          body: "Hoy tienes fuerza para llevar la barca hacia donde quieres, incluso contra la corriente. Cuando los demás dudan, que tú remes primero puede mover las cosas con más facilidad de la esperada. Pero así como remar a toda potencia todo el trayecto cansa los brazos, gastar el impulso de hoy al máximo durante todo el día puede dejarte sin fuerzas de golpe al anochecer. Regula tu ritmo y guarda algo de energía por el camino. En las relaciones, liderar y marcar el rumbo te va bien hoy, pero fíjate de vez en cuando en el ritmo de quien rema contigo. Una decisión firme y activa sobre dinero o trabajo probablemente traiga buenos resultados, pero evita un cambio de rumbo demasiado brusco. Cada remada de hoy te acerca un poco más a tu destino.",
        },
        {
          headline: "Tomar el timón",
          body: "Hoy te encuentras al timón de una situación que llevaba tiempo a la deriva. Darle una dirección clara a algo que estaba difuso suele tranquilizar lo bastante a quienes te rodean como para que la sigan. Decidir algo con firmeza hoy, en vez de aplazarlo, probablemente lleve a un mejor resultado en conjunto. Pero así como girar el timón demasiado deprisa hace que un barco se tambalee, los grandes cambios son más seguros con pequeños ajustes que con un giro brusco. Tomar la iniciativa en una conversación se siente natural hoy, pero ignorar por completo la opinión de la otra parte puede traer rechazo más adelante. Es un buen momento para fijar un nuevo rumbo en las finanzas o en los planes, así que si tienes una decisión pendiente, hoy es buen día para cerrarla. Sujeta el timón con firmeza, pero mantén la mirada en lo que viene.",
        },
        {
          headline: "Tensar el arco",
          body: "Como quien tensa un arco hacia su objetivo, hoy es un buen día para reunir tu energía y avanzar con decisión hacia lo que quieres. Incluso una propuesta o un reto que normalmente te harían dudar, hoy puedes impulsarlos con verdadera confianza. Pero así como la mano empieza a temblar si mantienes la cuerda tensa demasiado tiempo, prepararte sin llegar a soltar puede dejarte sin fuerzas justo en el momento que importa. Tirar con demasiada fuerza y durante demasiado tiempo puede agotar la energía que más necesitas. Decir con claridad lo que quieres funciona bien hoy en las relaciones, pero evita un tono que parezca apuntar a alguien. Una decisión firme sobre dinero o trabajo probablemente salga bien hoy. Suelta la cuerda en el momento justo y la flecha llegará exactamente donde querías.",
        },
      ],
      wealth: "Hoy, empujar con decisión tiende a traer dinero, pero cuida que una inversión o una compra demasiado agresiva no se convierta en una carga más adelante. Ve por lo que quieres, pero baja la intensidad.",
      love: "Tomar la iniciativa hace avanzar las cosas hoy, pero presionar demasiado puede resultar pesado para la otra persona. Ajusta también tu ritmo al suyo.",
      health: "Es probable que te sientas con más impulso de lo normal y te exijas más de la cuenta. El ejercicio y la actividad van bien hoy; solo baja un poco la intensidad habitual.",
    },
    otherChallengesSelf: {
      overviewVariants: [
        {
        ...
        },
        {
          ...
          body: "Hoy se parece menos a un camino despejado y más a estar ante una puerta estrecha por la que hay que pasar agachándote. Algo que normalmente saldría fácil puede venir con condiciones y limitaciones añadidas que piden moverte con más cuidado. Puede resultar frustrante, pero cuando cruces esta puerta es probable que al otro lado te espere un espacio distinto. Hoy toca menos empujar a la fuerza y más adaptarte con flexibilidad a la situación. En las relaciones, dar un paso atrás para conversar vale más que poner el orgullo por delante, y reduce los malentendidos. Las condiciones aún no están del todo dadas para una decisión importante sobre dinero o planes, así que es mejor no precipitarte y esperar la próxima oportunidad. Cuando pases, verás que la breve incomodidad de cruzar esta puerta no fue nada.",
        },
        {
          headline: "Olas que llegan una tras otra",

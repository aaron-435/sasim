...
const es: YearFortuneContent = {
  ...
  chungNote: "Este año también forma un 'cambio' con tu carta — con más movimiento, es un buen año para pasar a algo nuevo. Date un poco más de tiempo para las decisiones importantes.",  monthRelations: {
    mirror: {
      overview: "Un mes con una energía parecida a la tuya. Lo conocido encaja bien; el estímulo nuevo es algo menor.",
      wealth: "Lo conocido mantiene estable el dinero este mes.",
      love: "Las relaciones conocidas se sienten cómodas este mes.",
      career: "Buen mes para seguir con lo que haces.",
      study: "Buen mes para consolidar lo que ya sabes.",
      health: "Tu ritmo habitual se mantiene; el cuidado constante es la clave.",
      headline: "",
    },
    selfNurturesOther: {
      overview: "Un mes de volcar tu energía hacia fuera. Crece la expresión y lo que produces, pero también gastas energía más rápido.",
      wealth: "El gasto va fuerte este mes. Revísalo una vez.",
      love: "Buen mes para dar el primer paso. Solo complacer puede agotarte.",
      career: "Buen mes para llevar ideas a la acción, con ritmo medido.",
      study: "Buen mes para poner en práctica lo aprendido.",
      health: "Gastas mucha energía; planifica tu descanso a propósito.",
      headline: "",
    },
    otherNurturesSelf: {
      ...
      career: "Bueno para conocer a un mentor o colaborador.",
      study: "Lo que estudias se asienta bien.",
      health: "Buen mes para recuperarte y recargar.",
      headline: "",
    },
    selfChallengesOther: {
      overview: "Un mes en que crece tu fuerza para guiar. Avanza y cuida el ritmo de quienes te rodean.",
      wealth: "Buen mes para generar dinero de forma activa. Evita el exceso.",
      love: "Es fácil tomar la iniciativa. Fíjate también en su ritmo.",
      career: "Buen mes para empujar por resultados.",
      study: "Fija una meta y empuja, y llegan los resultados.",
      health: "La actividad sube. Dosifícate para no forzar el cuerpo.",
      headline: "",
    },
    otherChallengesSelf: {
      overview: "Un mes en que crecen la responsabilidad o la presión. Elegir tu ritmo te hace más firme.",
      wealth: "Ajustar el gasto te da más solidez este mes.",
      love: "Crece la responsabilidad en las relaciones este mes.",
      career: "Las cargas pesadas se vuelven crecimiento si las superas.",

/**
 * mobile/lib/sajuTypeCelebrities.ts
 * ------------------------------------------------------------------
 * Mobile-side port of web's lib/sajuTypeCelebrities.ts — same data, kept
 * in sync manually (see mobile/lib/sajuTypeContent.ts's header for why
 * this is a duplicate file rather than a cross-import).
 *

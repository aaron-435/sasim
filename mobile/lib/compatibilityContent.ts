...
export interface CompatibilityContent {
  relations: Record<CompatRelation, { headline: string; body: string; goodPoint: string; caution: string }>;
  bondNote: string;
}
...
const ko: CompatibilityContent = {
  relations: {
    mirror: {
      ...
      goodPoint: "설명하지 않아도 통하는 게 많아서 함께 있는 게 편안해요.",
      caution: "같은 지점에서 같이 막히기 쉬우니, 서로의 사각지대를 대신 봐줄 제3의 시선이 필요해요.",
    },
    selfNurturesOther: {
      headline: "내가 채워주는 쪽",
      body: "내 기운이 상대를 밀어주는 방향입니다. 상대가 자라는 걸 보는 게 기쁘지만, 계속 내주기만 하면 정작 내 쪽이 비어가는 걸 놓치기 쉬우니 가끔은 받는 연습도 필요합니다.",
      goodPoint: "내 기운이 상대를 밀어주는 방향이라, 상대가 자라는 모습을 보는 게 기쁨이 돼요.",
      caution: "계속 내주기만 하면 내 쪽이 비어가는 걸 놓치기 쉬우니, 가끔은 받는 연습도 해보세요.",
    },
    otherNurturesSelf: {
      headline: "내가 받는 쪽",
      body: "상대의 기운이 나를 밀어주는 방향입니다. 곁에 있으면 자연스럽게 힘이 나는 관계지만, 기대는 게 익숙해지면 스스로 채우는 법을 잊기 쉽습니다.",
      goodPoint: "상대의 기운이 나를 밀어주는 방향이라, 곁에 있으면 자연스럽게 힘이 나요.",
      caution: "기대는 게 익숙해지면 스스로 채우는 법을 잊기 쉬우니, 가끔은 혼자 채워보는 연습도 필요해요.",
    },
    selfChallengesOther: {
      headline: "내가 자극하는 쪽",
      body: "내가 상대를 눌러서라도 방향을 잡아주는 관계입니다. 서로를 성장시키는 힘이 크지만, 그 자극이 잔소리처럼 느껴지는 순간을 조심해야 합니다.",
      goodPoint: "내가 방향을 잡아주는 관계라, 서로를 성장시키는 힘이 커요.",
      caution: "그 자극이 잔소리처럼 느껴지는 순간을 조심하고, 애정에서 온 거라는 걸 자주 표현해주세요.",
    },
    otherChallengesSelf: {
      headline: "내가 자극받는 쪽",
      body: "상대가 나를 눌러서라도 정신 차리게 하는 관계입니다. 편하지만은 않아도 그만큼 나를 움직이게 하는 사람이라서, 그 압박이 애정에서 온다는 걸 서로 확인하는 게 중요합니다.",
      goodPoint: "상대가 나를 정신 차리게 하는 사람이라, 그만큼 나를 움직이게 해요.",
      caution: "편하지만은 않은 압박일 수 있으니, 그게 애정에서 온다는 걸 서로 확인해보세요.",
    },
  },
...
const en: CompatibilityContent = {
  relations: {
    mirror: {
      ...
      goodPoint: "You run on the same current, so a lot goes unsaid and still lands — being together feels easy.",
      caution: "You tend to stall at the exact same point, so it helps to have a third perspective catch what neither of you can see.",
    },
    selfNurturesOther: {
      ...
      goodPoint: "Your energy pushes theirs forward, and watching them grow becomes a real source of joy.",
      caution: "If you only ever give, your own side can quietly run empty — practice taking sometimes too.",
    },
    otherNurturesSelf: {
      ...
      goodPoint: "Their energy pushes yours forward, so being near them naturally lifts you.",
      caution: "Leaning on that can become a habit — make sure you still know how to refill on your own.",
    },
    selfChallengesOther: {
      ...
      goodPoint: "You give them direction, and that friction genuinely grows you both.",
      caution: "Watch for the moment it starts landing as nagging instead of care, and say the care part out loud.",
    },
    otherChallengesSelf: {
      ...
      goodPoint: "They keep you sharp — that's exactly why they move you.",
...
const es: CompatibilityContent = {
  relations: {
    ...
    selfNurturesOther: {
      ...
      goodPoint: "Tu energía impulsa a la de la otra persona, y ver cómo crece se convierte en una verdadera alegría.",
      caution: "Si solo das, puede que te vayas vaciando sin que lo notes: practica también el recibir.",
    },
    otherNurturesSelf: {

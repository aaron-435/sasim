...
export const ko = {
  ...
  home: {
    ...
    todayProNote: "하루·이번 주·이달·올해 흐름 전체는 Pro에서 열려요",
    ...
    prereqLabel: "AI 상담 · 심층 리포트",
    prereqDescription: "심리테스트를 마치면 이어서 열려요",
  ...
  fortune: {
    ...
    careerLabel: "직장운",
    studyLabel: "학업운",
    lockedHeading: "오늘 · 이번 주 · 이달 · 올해의 운세",
    lockedBody: "구독하면 매일 아침 오늘의 기운과 함께, 이번 주의 흐름, 이달의 좋은 날, 올해와 12개월의 흐름까지 모두 볼 수 있어요. 사주 Q&A도 하루 10개까지 물어볼 수 있어요.",

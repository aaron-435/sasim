...
export const ko = {
  ...
  fortune: {
    ...
    careerLabel: "직장운",
    studyLabel: "학업운",
    lockedHeading: "오늘 · 이번 주 · 이달 · 신년 운세",
    lockedBody: "구독하면 매일 아침 오늘의 기운과 함께, 이번 주의 흐름, 이달의 좋은 날, 다가오는 해와 그 12개월의 흐름까지 모두 볼 수 있어요. 사주 Q&A도 하루 10개까지 물어볼 수 있어요.",

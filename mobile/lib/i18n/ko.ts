...
export const ko = {
  ...
  home: {
    ...
    philosophySectionLabel: "사주를 대하는 우리의 태도",
    philosophyQuote: "사주는 미래를 예측하는 점술이 아닌, 타고난 기질과 환경의 흐름을 읽고 삶의 방향을 스스로 찾아가는 분석 도구입니다.",
    philosophyPoint1: "계절의 변화처럼, 인생에도 오고 가는 주기가 있습니다.",
    philosophyPoint2: "나의 성격·강점·약점·성향을 객관적으로 돌아보는 거울 역할로 자기 이해를 도와줍니다.",
    philosophyPoint3: "다가올 환경의 변화를 미리 참고해 더 나은 결정을 내리도록 돕는 내비게이션과 같습니다.",

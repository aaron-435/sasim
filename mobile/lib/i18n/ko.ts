...
export const ko = {
  ...
  shareCards: {
    heading: "내 사주 카드",
    subtitle: "친구에게 보여주고 싶은 한 장. 이미지로 저장하거나 공유할 수 있어요.",
    tabMoney: "돈 냄새 맡는 법",
    tabLove: "나를 설레게 하는 것",
    tabYear: "올해 빛나는 영역",
    tipLabel: "한 줄 힌트",
    spotLabel: "올해의 결",
    footer: "Fatesaid에서 나의 사주 카드 만들기",
    cardBy: (nickname: string) => `${nickname}님의 사주 카드`,
    shareButton: "카드 공유하기",
    lockedTitle: "올해 카드는 Pro에서 열려요",
    lockedBody: "신년 운세의 흐름에서 뽑은, 올해 가장 빛나는 영역을 카드로 만들어 드려요.",
    lockedCta: "Pro로 열리는 것 보기",
    loadError: "카드를 만들지 못했어요.",
    domains: { wealth: "재물", love: "연애", career: "일과 커리어", study: "배움", health: "몸과 마음 돌봄" },
  },
  yearReport: {
    heading: (year: number) => `${year} 신년 리포트`,
    subtitle: "다가오는 한 해를 읽는 리포트. 다섯 가지 분야, 12개월 타임라인, 네 단계 실행 계획을 담았어요.",
    previewLabel: "이 해의 결",
    chapterOverview: "한 해의 총론",
    chapterWealth: "재물",
    chapterLove: "관계와 연애",
    chapterCareer: "일과 커리어",
    chapterStudy: "배움",
    chapterHealth: "몸과 마음 돌봄",
    chapterTimeline: "12개월 타임라인",
    chapterPlan: "네 단계 실행 계획",
    lockedNote: "구매하면 아래가 모두 열려요",
    buyButton: (price: string | null) => (price ? `리포트 열기 · ${price}` : "리포트 열기"),
    buying: "결제 중...",
    restore: "구매 복원",
    restoring: "복원 중...",
    oneTimeNote: "한 번 구매하면 이 해의 리포트를 계속 다시 볼 수 있어요. 구독이 아니에요.",
    priceAtCheckout: "가격은 결제 화면에서 확인할 수 있어요.",
    generating: ["당신의 12개월을 읽고 있어요...", "다섯 가지 분야를 쓰고 있어요...", "아직 쓰는 중이에요. 1분 정도 걸릴 수 있어요..."],
    timelineHeading: "12개월 타임라인",
    vsProNote: "구독(Pro)의 신년 운세 탭은 주제별로 짚어 주는 요약이에요. 이 리포트는 다섯 분야를 깊이 풀고 12개월 타임라인과 실행 계획까지 담은 전체 버전이라, 매년 한 번씩 따로 구매해요.",
    timelineNote: "월은 입춘(2월 초)에 시작하는 사주 달력 순서예요.",
    planHeading: "실행 계획",
    errorGeneric: "리포트를 만들지 못했어요. 다시 시도해 주세요.",
    errorPaidButFailed: "결제는 확인됐어요. 리포트를 만드는 중 문제가 생겼어요. 잠시 후 다시 시도해 주세요.",
    errorNotPurchased: "이 리포트의 구매를 확인하지 못했어요. 구매 복원을 눌러 보세요.",
    ...
    restoreFailed: "구매 내역을 확인하지 못했어요. 연결을 확인한 뒤 다시 시도해 주세요.",
    tabCardTitle: (year: number) => `${year} 신년 리포트`,
    tabCardBody: "이 탭의 흐름을 5개 분야, 12개월, 실행 계획까지 깊게 풀어 쓴 리포트예요. 한 번 구매로 계속 볼 수 있어요.",
    tabCardCta: "리포트 보기",
    monthName: (m: number) => `${m}월`,
  },
  pdf: {
    button: "PDF로 저장",
    preparing: "PDF를 만드는 중...",
    dialogTitle: "PDF로 저장",
    errorUnsupported: "이 기능은 다음 앱 업데이트에서 사용할 수 있어요.",
    errorNotPurchased: "이 리포트의 구매를 확인하지 못했어요. 구매 복원을 눌러 보세요.",
    errorUnavailable: "지금은 PDF를 만들 수 없어요. 잠시 후 다시 시도해 주세요.",
    errorRateLimited: "요청이 많아 잠시 후 다시 시도해 주세요.",
    errorFailed: "PDF를 만들지 못했어요. 연결을 확인한 뒤 다시 시도해 주세요.",
  },
  home: {
    featureYearReportLabel: (year: number) => `${year} 신년 리포트`,
    featureYearReportDescription: "12개월 흐름과 실행 계획을 담은 한 권",
    featureCardsLabel: "내 사주 카드",
    featureCardsDescription: "돈, 연애, 올해 — 친구에게 보여주고 싶은 한 장",
  ...
  settings: {
    ...
    legalSectionLabel: "구독·약관",
    manageSubscription: "구독 관리",
    termsLinkSettings: "이용약관",
    privacyLinkSettings: "개인정보처리방침",
  ...
  fortune: {
    ...
    lockedBenefits: [
      ...
      { title: "신년 운세", body: "다가오는 해와 그 12개월의 흐름을 주제별로 짚은 요약 (깊이 풀어 쓴 신년 리포트는 별도 구매)" },
  ...
  qa: {
    ...
    subscriptionPriceFor: (price: string) => `월 ${price}`,
    defaultNickname: "회원",
    greeting1: (nickname: string) => `안녕하세요, ${nickname}님!`,
    greeting2: "Fatesaid는 사주와 심리검사 결과를 함께 읽고, 여기서의 답변은 AI가 작성해요.",
  ...
  report: {
    ...
    loadingMessages: ["사주와 심리검사를 함께 읽고 있어요...", "당신만의 이야기를 쓰고 있어요...", "모든 숫자를 당신의 차트와 대조하고 있어요...", "당신이 읽게 될 모습 그대로 한 번 더 읽어 보고 있어요...", "거의 다 됐어요. 이렇게 자세한 리포트는 최대 2분까지 걸릴 수 있어요. 기다린 만큼 값어치가 있어요..."],
    ...
    previewPagesLabel: (free: number, total: number) => `전체 ${total}페이지 중 ${free}페이지 미리보기`,
    tocEyebrow: "목차",
    tocTitle: "이 리포트에서\n다룰 이야기",
    ...
    paywallDecadePreview: (age: number, element: string) => `${age}세부터 완전히 다른 기운이 시작돼요`,

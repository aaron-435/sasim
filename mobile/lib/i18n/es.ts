...
export const es: typeof ko = {
  ...
  fortune: {
    ...
    lockedBody: "Suscríbete y se abre todo lo de abajo.",
    lockedBenefits: [
      { title: "Lectura de hoy", body: "Abre la lectura de cada mañana: el ritmo de hoy, dinero, amor, salud y puntos de suerte" },
      ...
      { title: "El año que viene", body: "El año que llega y sus 12 meses, por temas" },

...
export const es: typeof ko = {
  ...
  home: {
    ...
    todayUnlockCta: "Abre la lectura completa con Pro",
  ...
  fortune: {
    ...
    careerLabel: "Trabajo",
    studyLabel: "Estudios",
    lockedHeading: "Tu día, semana, mes y el año que viene",
    lockedBody: "Suscríbete para ver la energía de hoy cada mañana, además del flujo de tu semana, los mejores días del mes y el año que viene mes a mes. También puedes hacer hasta 10 preguntas de Saju Q&A al día.",

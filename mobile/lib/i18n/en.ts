...
export const en: typeof ko = {
  ...
  home: {
    ...
    todayUnlockCta: "Unlock the full reading with Pro",
  ...
  fortune: {
    ...
    careerLabel: "Career",
    studyLabel: "Study",
    lockedHeading: "Your day, week, month and year ahead",
    lockedBody: "Subscribe to see today's energy every morning, plus your week's flow, this month's best days, and the year ahead month by month. You also get up to 10 Saju Q&A questions a day.",

...
export const en: typeof ko = {
  ...
  home: {
    ...
    todayProNote: "The full day, week, month and year flow opens with Pro",
    ...
    prereqLabel: "AI Counseling · In-Depth Report",
    prereqDescription: "Unlocks after you finish a psych test",
  ...
  fortune: {
    ...
    careerLabel: "Career",
    studyLabel: "Study",
    lockedHeading: "Your day, week, month and year",
    lockedBody: "Subscribe to see today's energy every morning, plus your week's flow, this month's best days, and your year month by month. You also get up to 10 Saju Q&A questions a day.",

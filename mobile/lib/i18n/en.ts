...
export const en: typeof ko = {
  ...
  home: {
    ...
    featureQuizDescription: "The first step to understanding yourself · finish one to unlock AI Counseling and the In-Depth Report",
  ...
  fortune: {
    ...
    lockedBenefits: [
      { title: "Today's fortune", body: "Open the seal each morning: today's rhythm, wealth, love, health and lucky points" },
  ...
  report: {
    ...
    loadingMessages: ["Integrating your saju and psych test results...", "Writing your own story...", "Still writing — this can take up to a minute..."],
    ...
    paywallBody: "Chat-quote analysis, saju × psychology cross-analysis, strengths and weaknesses, environments that fit you, and behavior guides — the rest of this report, through to the last page.",

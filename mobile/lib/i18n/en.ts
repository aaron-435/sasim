...
export const en: typeof ko = {
  ...
  fortune: {
    ...
    lockedBody: "Subscribe and everything below opens up.",
    lockedBenefits: [
      { title: "Today's fortune", body: "Open today's reading each morning: today's rhythm, wealth, love, health and lucky points" },
      ...
      { title: "The year ahead", body: "The coming year and its 12 months, by topic" },

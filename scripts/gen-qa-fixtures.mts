...
const L: any = {
  ko: { module: "번아웃", type: "완주형 소진", hook: "끝까지 해내는 대신 끝까지 지친다", summary: "완벽주의가 높고 회복이 낮은 편이에요.", dims: { perfectionism: "완벽주의", recovery: "회복" },
        answers: [["일을 끝낸 뒤 나는?", "다시 처음부터 훑어본다"], ["쉬는 날 나는?", "쉬어도 마음이 불편하다"]],
        chat: { primary_concern: "쉬어도 쉬는 것 같지 않아요", emotional_state: "지쳤고 조금 불안함", trigger_point: "월요일 아침 메신저 알림", repeat_pattern: "몰아서 하고 무너지기", core_fear_or_meaning: "뒤처질까 봐 멈출 수 없어요" } },
  en: { module: "Burnout", type: "Finisher's Drain", hook: "Finishes everything, and is finished by it", summary: "Perfectionism runs high and recovery runs low.", dims: { perfectionism: "Perfectionism", recovery: "Recovery" },
        answers: [["After finishing a task I…", "Go back and re-check everything"], ["On a day off I…", "Feel uneasy even when I rest"]],
        chat: { primary_concern: "I rest but it never feels like resting", emotional_state: "Tired and a little anxious", trigger_point: "Monday-morning messages", repeat_pattern: "Cramming, then crashing", core_fear_or_meaning: "I'm afraid that if I stop I'll fall behind" } },
  es: { module: "Agotamiento", type: "Quien termina todo y se agota", hook: "Termina todo, y todo termina con su energía", summary: "El perfeccionismo es alto y la recuperación es baja.", dims: { perfectionism: "Perfeccionismo", recovery: "Recuperación" },
        ...
        chat: { primary_concern: "Descanso, pero nunca se siente como descanso", emotional_state: "Cansancio y un poco de ansiedad", trigger_point: "Los mensajes del lunes por la mañana", repeat_pattern: "Acumular y luego derrumbarme", core_fear_or_meaning: "Me da miedo quedarme atrás si paro" } },
};

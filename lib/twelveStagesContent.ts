/**
 * lib/twelveStagesContent.ts
 * ------------------------------------------------------------------
 * Content for the two classical cycles in lib/twelveStages.ts — indices
 * here must line up exactly with LIFE_STAGE_ORDER / SINSAL_ORDER there.
 *
...
const es: TwelveStagesContent = {
  lifeStages: [
    { name: "Nacimiento", body: "Hoy surge una corriente nueva. Los intentos poco familiares se reciben mejor de lo esperado, y una persona o situación nueva podría convertirse en algo bueno." },
    { name: "Renovación", body: "Hoy las emociones salen a la superficie con facilidad y bajas la guardia. La ilusión es real, pero evita decisiones impulsivas — deja que lo que sientes se asiente un día antes de actuar." },
    { name: "Impulso", body: "Hoy crece tu confianza y tu presencia pesa más. Es un buen momento para dar por fin el paso que venías postergando — convierte la energía de hoy en una acción real." },
    { name: "Máximo Esfuerzo", body: "Hoy el esfuerzo se nota en los resultados. Es un día fuerte especialmente para el trabajo y la carrera — presenta esa propuesta o desafío que tenías guardado." },
    { name: "Máximo Poder", body: "Este es el punto más fuerte de tu ciclo hoy. Bueno para tomar el mando y avanzar — solo cuida que esa fuerza no te haga perder de vista a quienes te rodean." },
    { name: "Desaceleración", body: "Hoy conviene bajar el ritmo en vez de forzarlo. Deja las decisiones grandes para mañana y dedica el día a pulir lo que ya está en marcha." },
    { name: "Fatiga", body: "Hoy el cuerpo y la mente se cansan más fácilmente. Haz de tu estado la prioridad — evita lo demasiado exigente y deja que te ayuden sin resistirte." },
    { name: "Punto Muerto", body: "Hoy conviene más pausar y ordenar que empezar algo nuevo. Un momento tranquilo de reflexión prepara tu próximo movimiento." },
    { name: "Reposo", body: "Se ve tranquilo por fuera, pero algo se está gestando por dentro para después. No apresures los resultados — usa el tiempo a solas para recargarte." },
    { name: "Reinicio", body: "Un capítulo se cierra para dar paso al siguiente. Suelta lo que haya que soltar — aferrarte solo bloquea el espacio que necesita la nueva energía para llegar." },
    { name: "Concepción", body: "Hoy una nueva posibilidad echa raíces en silencio, aunque todavía no se vea. No esperes resultados inmediatos — solo siembra la idea y déjala estar." },
    { name: "Incubación", body: "Lo que sembraste antes ahora crece en silencio. El cuidado constante importa más que la velocidad — el pequeño esfuerzo de hoy dará frutos después." },
  ],
  sinsal: [
    { name: "Vulnerabilidad", body: "Hoy la energía — o los recursos — pueden escapársete por donde no lo esperas. Revisa dos veces cualquier asunto de dinero u objetos de valor antes de avanzar." },
    { name: "Fricción", body: "Hoy es más probable que surjan desacuerdos o conflictos. Dar un paso atrás en vez de tener la razón probablemente te cueste menos al final." },
    { name: "Comodín", body: "Algo fuera de tu control puede interrumpir tus planes hoy. Si las cosas no salen como esperabas, no te alarmes — la flexibilidad te sirve más que la resistencia." },
    { name: "Terreno Nuevo", body: "Hoy favorece el movimiento — un lugar nuevo, un entorno nuevo, un cambio de escena. Un entorno o una persona desconocida podría convertirse en una oportunidad, así que no le huyas." },
    { name: "Magnetismo", body: "Hoy estás más notable y atractivo/a de lo habitual. Es un buen día para una conexión nueva o un encuentro emocionante — déjate ver." },
    { name: "Sequía", body: "Hoy puede sentirse estancado hagas lo que hagas. En vez de forzarlo, puede ser más inteligente pausar y simplemente esperar a que pase." },
    { name: "Exposición", body: "Hoy tus palabras o acciones podrían interpretarse distinto de lo que quieres decir. Revisa dos veces lo importante y evita reaccionar desde la emoción." },
    { name: "Mando", body: "Hoy es un día fuerte para tomar la delantera. La decisión te gana confianza hoy — no dudes en dar el paso al frente." },
    { name: "Ascenso", body: "El esfuerzo pasado podría traducirse hoy en reconocimiento real — un ascenso, una selección, una buena oferta. Si aparece esa oportunidad, tómala." },

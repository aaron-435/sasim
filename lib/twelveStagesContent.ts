...
const en: TwelveStagesContent = {
  lifeStages: [
    ...
    { name: "Winding Down", body: "Body and mind tire more easily than usual today. Make your condition the priority — skip anything overly demanding and let people help you without resistance." },
    { name: "A Pause to Tidy Up", body: "Today rewards pausing and tidying up over starting something new. A quiet stretch of reflection now sets up your next move." },
  ...
  sinsal: [
    { name: "Unexpected Turns", body: "Energy — or resources — can slip away from an unexpected direction today. Double-check anything involving money or valuables before moving forward." },
    ...
    { name: "Waiting Time", body: "Today can feel stuck no matter what you try. Rather than forcing it, it may be smarter to pause and simply wait this one out." },
    { name: "Misread Moments", body: "Words or actions could land differently than you intend today. Double-check anything important, and hold off on reacting emotionally." },
    ...
    { name: "Small Hiccups", body: "Small, nagging things may pile up today without being serious. A little extra care with your health or schedule keeps it manageable." },

/**
 * lib/sajuTypeContent.ts
 * ------------------------------------------------------------------
 * lib/sajuType.ts가 판정한 유형의 표시 문구(KO/EN/ES).
 *
 * 왜 i18n 사전(lib/i18n/ko.ts)이 아니라 별도 파일인가: 사전은 화면 크롬
 * 문자열용이고, 문항 뱅크·GPT 프롬프트 같은 "콘텐츠"는 각자 자기 모듈에
 * 두는 게 이 저장소의 기존 관례다(lib/i18n/ko.ts 헤더 주석 참고).
 *
...
const es: SajuTypeContent = {
  archetypes: {
    oak: {
      ...
      body: "Cuando eliges una dirección, avanzas sin mirar atrás. Ese mismo tronco que te sostiene cuesta que se doble, así que sueles mantener una postura mucho después de que soltarla te costaría menos.",
    },
    vine: {
      name: "La enredadera",
      tagline: "La trepadora que llega rodeando",
      body: "En vez de chocar de frente con el obstáculo, buscas la manera de rodearlo. Puedes parecer flexible y suave, pero nunca sueltas el objetivo: quien te observa durante un tiempo se sorprende de esa constancia.",
    },
    sun: {
      name: "El sol",
      tagline: "Luz que cae sobre todo sin elegir",
      body: "Lo que sientes se nota, así que los demás te leen con facilidad y rara vez te malinterpretan. El precio es que, cuando te apagas, también se ve.",
    },
    flame: {
      name: "La llama",
      tagline: "Un punto de luz en medio de la oscuridad",
      body: "Das calor de verdad a unas pocas personas, en lugar de un calor tenue a muchas. Esa sensibilidad capta lo que otros pasan por alto, y hace que el ambiente a tu alrededor te afecte más de lo que quisieras.",
    },
    mountain: {
      name: "La montaña",
      tagline: "Peso que se convierte en referencia por no moverse",
      body: "Mantienes tu lugar sin prisa y los demás se orientan contigo. La otra cara es que cambiar una idea ya asentada te lleva mucho más tiempo que a la mayoría.",
    },
    field: {
      name: "El campo",
      tagline: "Tierra que existe para que algo crezca",
      body: "Se te da mejor abrir espacio para que otros crezcan que reclamar el tuyo. Tienes sentido práctico y sabes acoger, pero puedes seguir cediendo terreno hasta que tu propio campo se queda vacío.",
    },
    steel: {
      name: "El acero",
      tagline: "Metal duro, todavía sin pulir",
      body: "Vas directo a la decisión, sin rodeos, y eso genera confianza. En momentos que piden primero la versión suave, esa misma franqueza puede sentirse como un corte.",
    },
    gem: {
      name: "La gema",
      tagline: "Metal que brilla en proporción a lo que se le quita",
      body: "Tu ojo capta diferencias que otros no ven. Te aplicas ese mismo criterio, y por eso un trabajo que ya está bien rara vez te parece terminado.",
    },
    ocean: {
      name: "El océano",
      tagline: "Agua tan amplia que lo recibe todo",
      body: "Absorbes mucho sin inmutarte y piensas en grande. A cambio, resulta difícil leerte, y cuando tu corriente cambia, quienes te rodean no lo ven venir.",
    },
    dew: {
      name: "El rocío",
      tagline: "Agua que penetra sin hacer ruido",
      body: "Observas en silencio y luego nombras lo esencial. Tardan en notarte porque no te anuncias, pero aquello en lo que calas queda cambiado.",
    },
  },
  modes: {
    rooted: {
      name: "Raíz",
      tagline: "Tu mapa se inclina hacia tu propio elemento",
      body: "Tu color propio es intenso y no te adaptas con facilidad al criterio ajeno. Es una gran fortaleza para valerte por tu cuenta; la fricción aparece cuando toca avanzar como un solo equipo.",
    },
    voice: {
      name: "Voz",
      tagline: "Tu mapa se inclina hacia lo que expresas",
      body: "Únicamente te calmas cuando lo que llevas dentro sale, ya sea hablado, escrito o hecho. El talento aflora con facilidad, y un entorno que bloquea la expresión te agota muy rápido.",
    },
    harvest: {
      name: "Cosecha",
      tagline: "Tu mapa se inclina hacia lo que alcanzas y logras",
      body: "Manejas bien lo práctico y prefieres demostrar con resultados. Te mueves rápido, y lo que no se puede medir tiende a quedar para después.",
    },
    order: {
      name: "Orden",
      tagline: "Tu mapa se inclina hacia lo que te exige",
      body: "La responsabilidad y un rol definido te vuelven más firme, no más frágil. Sostienes bien la presión, y sigues exigiéndote incluso cuando podrías descansar.",
    },
    well: {
      name: "Pozo",
      tagline: "Tu mapa se inclina hacia lo que te nutre",
      body: "Construyes profundidad aprendiendo y dándole vueltas a las cosas. Tu comprensión es honda; el tramo entre saber lo suficiente y ponerte en marcha es más largo que para otros.",
    },
  },
};

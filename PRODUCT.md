...
- Web (fatesaidapp.com, Next.js) is a lead-gen surface only: ad traffic lands there, gets a free taste of Q&A, and is sent to install the app. No payment or login on web.
...
- Share cards (saju type, compatibility) exported as images for social stories.
...
- Voice: warm counselor, never cynical or fear-driven. The AI chat is a completed 20-turn conversation with safety and no-direct-advice rules; no forced cut-offs or fake urgency timers.

    ...
    <div style={{ minHeight: "100vh", width: "100%", background: "#122019", backgroundImage: "radial-gradient(circle at 50% -10%, rgba(111,169,139,0.10), transparent 55%)", display: "flex", justifyContent: "center" }}>
      <style dangerouslySetInnerHTML={{ __html: `
        ...
        .qq-card {
          ...
          border-radius: 12px; padding: 14px 16px; color: #D9C9A3; cursor: pointer;
        ...
        .qq-card:hover { border-color: #6FA98B; background: rgba(111,169,139,0.05); }
        .qq-back { background: none; border: none; color: #7C8A82; cursor: pointer; display: flex; align-items: center; gap: 4px; padding: 8px; margin: -8px 0 20px -8px; font-size: 13px; }
        .qq-root button:focus-visible { outline: 2px solid #6FA98B; outline-offset: 2px; }
      ` }} />
